...
public class Vehicle : IVehicle
{
    ...
    public Vehicle(string make, string regNo, double odometer, double costKm, double costDay, VehicleStatuses status, VehicleTypes type)
        => (Make, RegNo, Odometer, CostKm, CostDay, Status, Type) = (make, regNo, odometer, costKm, costDay, status, type);
